...
@section('title', __('Published Jobs'))
@section('category', __('Published Jobs'))
...
@section('content')
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">{{ __('Show all published jobs') }}</h5>

            <livewire:backend.jobs.published-jobs />
