...
<head>
    ...
    <title> {{ __('Disbleer - Registration a new membership') }} </title>
                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="d-flex justify-content-center py-4">
                                <a href="index.html" class="logo d-flex align-items-center w-auto">
                                    ...
                                    <span class="d-none d-lg-block">{{ __(env('APP_NAME')) }}</span>
                                </a>
                            </div><!-- End Logo -->
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4">
                                            {{ __('Create a new membership') }} </h5>
                                        <p class="text-center small">
                                            {{ __('Enter your personal details as disable persone') }}</p>
                                    </div>

                                    <form class="row g-3 needs-validation" novalidate method="POST"
                                        action="{{ route('clientv1.reg.submit') }}">
                                        @csrf
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            <div class="form-check">
                                                <input
                                                    class="form-check-input @error('terms')
                                                is-invalid
                                            @enderror"
                                                    name="terms" type="checkbox" value="" id="acceptTerms"
                                                    required>
                                                <label class="form-check-label" for="acceptTerms">
                                                    {{ __('I agree and accept the') }} <a
                                                        href="{{ route('clientv1.terms') }}">
                                        ...
                                        <div class="col-12">
                                            <p class="small mb-0">
                                                ...
                                                <a href="{{ route('clientv1.login') }}"> {{ __('Log in') }} </a>
                                            </p>
                                        </div>
                                    </form>
