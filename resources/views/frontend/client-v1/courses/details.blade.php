            ...
            <div class="row">
                <div class="col-md-10 mx-auto">
                    <div id="courseCarousel" class="carousel slide" data-ride="carousel">
                        ...
                        <!-- Controls -->
                        <a class="carousel-control-prev" style="display: none;" href="#courseCarousel" role="button" data-slide="prev">
                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                            <span class="sr-only"> {{ __('Previous') }} </span>
                        </a>
                        <a class="carousel-control-next" style="display: none;" href="#courseCarousel" role="button" data-slide="next">
